...
const transactionSchema = new mongoose_1.Schema({
    ...
    source: {
        type: String,
        required: true,
        enum: Object.values(transaction_interface_1.TRANSACTION_SOURCE),
    },
    senderEmail: { type: String, default: null },
    senderId: { type: mongoose_1.default.Types.ObjectId, ref: "User", default: null },
    receiverEmail: { type: String, default: null },
    receiverId: { type: mongoose_1.default.Types.ObjectId, ref: "User", default: null },
    amount: { type: Number },
